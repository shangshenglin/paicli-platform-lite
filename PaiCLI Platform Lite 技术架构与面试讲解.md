...
当前项目回归测试覆盖 RunProcessor、工具失败恢复、Approval Flow、ContextManager、SQLite Store、模型重试/Fallback、DeepSeek/多模态请求与 SSE 解析、Docker Driver、Local Driver、API Key、Artifact、图片/文档附件、长 Markdown/Tika 提取、结构化分块、混合 RAG、MCP、Skill 和 Memory，现有 43 项测试通过。
